...
→ 새로운 Dataset 구축 시, 데이터를 어떻게 수집할 계획인지? <br>
→ 기존 Dataset 활용 시, 만약 사용자 모집단을 위해 변경 또는 추가해야 하는 경우 어떻게 해야하는지? <br>
{:.note}
...
라벨러를 위한 도구를 설계하기 전 최종 사용자에 대해 생각하는 것과 같은 방식으로 라벨러의 니즈를 조사해야 하며, 이는 그들의 동기와 능력이 우리가 구축하는 모든 것에 직접적인 영향을 미치기 때문 <br>
Q. 라벨러는 어떤 작업자들인지? <br>
